  ...
  <div class="container">
    <div class="content-container">
        ...
        <div class="comment-show">
            ...
            <comment-box v-for="comment in comments" :comment="comment" :key="comment.id" @replyComment="replyComment" @replySonComment="replySonComment" type="second"></comment-box>
